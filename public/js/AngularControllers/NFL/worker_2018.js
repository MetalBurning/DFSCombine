...
(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  onmessage = function(e) {
    //console.log(e.data);
    var Test_Drafts = Test_BuildDrafts(e);
    console.log(Test_Drafts);
    var Drafts = BuildDrafts(e);
    self.postMessage(Drafts);
  };
  function Test_BuildDrafts(playerData) {
    ...
    var _FLEXPlayerPool = playerData.data[7];
    ...
    var playerIDs = [];
    var AllPlayers = [];
    _QBPlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
      if(playerIDs.indexOf(DSTPlayer.playerID) === -1) {
        playerIDs.push(DSTPlayer.playerID);
      }
      if(AllPlayers.indexOf(DSTPlayer) === -1) {
        AllPlayers.push(DSTPlayer);
      }
    });
    _QBPlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
    ...
    _RB1PlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
      if(playerIDs.indexOf(DSTPlayer.playerID) === -1) {
    ...
    _RB2PlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
      if(playerIDs.indexOf(DSTPlayer.playerID) === -1) {
    ...
    _WR1PlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
      if(playerIDs.indexOf(DSTPlayer.playerID) === -1) {
    ...
    _WR2PlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
      if(playerIDs.indexOf(DSTPlayer.playerID) === -1) {
    ...
    _WR3PlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
    });
    _TEPlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
      if(playerIDs.indexOf(DSTPlayer.playerID) === -1) {
    ...
    _FLEXPlayerPool.forEach(function(DSTPlayer) {
      if(teams.indexOf(DSTPlayer._Team) === -1) {
        teams.push(DSTPlayer._Team);
      }
      if(playerIDs.indexOf(DSTPlayer.playerID) === -1) {
    ...
    model['optimize'] = 'projection';
    model['opType'] = 'max';
    model['constraints'] = new Object();
    model['constraints']['salary'] = new Object();
    model['constraints']['salary']['max'] = 60000;
    model['constraints']['position_qb'] = new Object();
    model['constraints']['position_qb']['equal'] = 1;

    model['constraints']['position_rb1'] = new Object();
    model['constraints']['position_rb1']['equal'] = 1;

    model['constraints']['position_rb2'] = new Object();
    model['constraints']['position_rb2']['equal'] = 1;

    model['constraints']['position_wr1'] = new Object();
    model['constraints']['position_wr1']['equal'] = 1;

    model['constraints']['position_wr2'] = new Object();
    model['constraints']['position_wr2']['equal'] = 1;

    model['constraints']['position_wr3'] = new Object();
    model['constraints']['position_wr3']['equal'] = 1;

    model['constraints']['position_te'] = new Object();
    model['constraints']['position_te']['equal'] = 1;

    model['constraints']['position_flex'] = new Object();
    model['constraints']['position_flex']['equal'] = 1;

    model['constraints']['position_dst'] = new Object();
    model['constraints']['position_dst']['equal'] = 1;

    teams.forEach(function(singleTeam) {
      model['constraints'][singleTeam] = new Object();
      model['constraints'][singleTeam]['max'] = 4;
      model['constraints'][singleTeam]['min'] = 0;
    });
    playerIDs.forEach(function(singleID) {
      model['constraints'][singleID] = new Object();
      model['constraints'][singleID]['max'] = 1;
      model['constraints'][singleID]['min'] = 0;

    });

    model.variables = new Object();

    _QBPlayerPool.forEach(function(QBPlayer) {
      model['variables'][QBPlayer._Name+"_QB"] = new Object();
      model['variables'][QBPlayer._Name+"_QB"].salary = QBPlayer._Salary;
      model['variables'][QBPlayer._Name+"_QB"].position_qb = 1;
      model['variables'][QBPlayer._Name+"_QB"].position_rb = 0;
      model['variables'][QBPlayer._Name+"_QB"].position_wr1 = 0;
      model['variables'][QBPlayer._Name+"_QB"].position_wr2 = 0;
      model['variables'][QBPlayer._Name+"_QB"].position_wr3 = 0;
      model['variables'][QBPlayer._Name+"_QB"].position_te = 0;
      model['variables'][QBPlayer._Name+"_QB"].position_flex = 0;
      model['variables'][QBPlayer._Name+"_QB"].position_dst = 0;
      model['variables'][QBPlayer._Name+"_QB"].projection = QBPlayer._FPPG;
      model['variables'][QBPlayer._Name+"_QB"].projection1 = QBPlayer._FPPG;

      model['variables'][QBPlayer._Name+"_QB"][QBPlayer.playerID] = 1;
      model['variables'][QBPlayer._Name+"_QB"]['VS_'+QBPlayer._Team] = 1;

      teams.forEach(function(singleTeam) {
        if(singleTeam === QBPlayer._Team) {
          model['variables'][QBPlayer._Name+"_QB"][singleTeam] = 1;
        }
        else {
          model['variables'][QBPlayer._Name+"_QB"][singleTeam] = 0;
        }
      });
    });
    _RB1PlayerPool.forEach(function(RBPlayer) {
      model['variables'][RBPlayer._Name+"_RB1"] = new Object();
      model['variables'][RBPlayer._Name+"_RB1"].salary = RBPlayer._Salary;
      model['variables'][RBPlayer._Name+"_RB1"].position_qb = 0;
      model['variables'][RBPlayer._Name+"_RB1"].position_rb1 = 1;
      model['variables'][RBPlayer._Name+"_RB1"].position_rb2 = 0;
      model['variables'][RBPlayer._Name+"_RB1"].position_wr1 = 0;
      model['variables'][RBPlayer._Name+"_RB1"].position_wr2 = 0;
      model['variables'][RBPlayer._Name+"_RB1"].position_wr3 = 0;
      model['variables'][RBPlayer._Name+"_RB1"].position_te = 0;
      model['variables'][RBPlayer._Name+"_RB1"].position_flex = 0;
      model['variables'][RBPlayer._Name+"_RB1"].position_dst = 0;
      model['variables'][RBPlayer._Name+"_RB1"].projection = RBPlayer._FPPG;
      model['variables'][RBPlayer._Name+"_RB1"].projection1 = RBPlayer._FPPG;

      model['variables'][RBPlayer._Name+"_RB1"][RBPlayer.playerID] = 1;
      model['variables'][RBPlayer._Name+"_RB1"]['VS_'+RBPlayer._Team] = 1;

      teams.forEach(function(singleTeam) {
        if(singleTeam === RBPlayer._Team) {
          model['variables'][RBPlayer._Name+"_RB1"][singleTeam] = 1;
        }
        else {
          model['variables'][RBPlayer._Name+"_RB1"][singleTeam] = 0;
        }
      });
    });
    _RB2PlayerPool.forEach(function(RBPlayer) {
      model['variables'][RBPlayer._Name+"_RB2"] = new Object();
      model['variables'][RBPlayer._Name+"_RB2"].salary = RBPlayer._Salary;
      model['variables'][RBPlayer._Name+"_RB2"].position_qb = 0;
      model['variables'][RBPlayer._Name+"_RB2"].position_rb1 = 0;
      model['variables'][RBPlayer._Name+"_RB2"].position_rb2 = 1;
      model['variables'][RBPlayer._Name+"_RB2"].position_wr1 = 0;
      model['variables'][RBPlayer._Name+"_RB2"].position_wr2 = 0;
      model['variables'][RBPlayer._Name+"_RB2"].position_wr3 = 0;
      model['variables'][RBPlayer._Name+"_RB2"].position_te = 0;
      model['variables'][RBPlayer._Name+"_RB2"].position_flex = 0;
      model['variables'][RBPlayer._Name+"_RB2"].position_dst = 0;
      model['variables'][RBPlayer._Name+"_RB2"].projection = RBPlayer._FPPG;
      model['variables'][RBPlayer._Name+"_RB2"].projection1 = RBPlayer._FPPG;

      model['variables'][RBPlayer._Name+"_RB2"][RBPlayer.playerID] = 1;
      model['variables'][RBPlayer._Name+"_RB2"]['VS_'+RBPlayer._Team] = 1;

      teams.forEach(function(singleTeam) {
        if(singleTeam === RBPlayer._Team) {
          model['variables'][RBPlayer._Name+"_RB2"][singleTeam] = 1;
        }
        else {
          model['variables'][RBPlayer._Name+"_RB2"][singleTeam] = 0;
        }
      });
    });
    _WR1PlayerPool.forEach(function(WRPlayer) {
      model['variables'][WRPlayer._Name+"_WR1"] = new Object();
      model['variables'][WRPlayer._Name+"_WR1"].salary = WRPlayer._Salary;
      model['variables'][WRPlayer._Name+"_WR1"].position_qb = 0;
      model['variables'][WRPlayer._Name+"_WR1"].position_rb1 = 0;
      model['variables'][WRPlayer._Name+"_WR1"].position_rb2 = 0;
      model['variables'][WRPlayer._Name+"_WR1"].position_wr1 = 1;
      model['variables'][WRPlayer._Name+"_WR1"].position_wr2 = 0;
      model['variables'][WRPlayer._Name+"_WR1"].position_wr3 = 0;
      model['variables'][WRPlayer._Name+"_WR1"].position_te = 0;
      model['variables'][WRPlayer._Name+"_WR1"].position_flex = 0;
      model['variables'][WRPlayer._Name+"_WR1"].position_dst = 0;
      model['variables'][WRPlayer._Name+"_WR1"].projection = WRPlayer._FPPG;
      model['variables'][WRPlayer._Name+"_WR1"].projection1 = WRPlayer._FPPG;

      model['variables'][WRPlayer._Name+"_WR1"][WRPlayer.playerID] = 1;
      model['variables'][WRPlayer._Name+"_WR1"]['VS_'+WRPlayer._Team] = 1;

      teams.forEach(function(singleTeam) {
        if(singleTeam === WRPlayer._Team) {
          model['variables'][WRPlayer._Name+"_WR1"][singleTeam] = 1;
        }
        else {
          model['variables'][WRPlayer._Name+"_WR1"][singleTeam] = 0;
        }
      });
    });
    _WR2PlayerPool.forEach(function(WRPlayer) {
      model['variables'][WRPlayer._Name+"_WR2"] = new Object();
      model['variables'][WRPlayer._Name+"_WR2"].salary = WRPlayer._Salary;
      model['variables'][WRPlayer._Name+"_WR2"].position_qb = 0;
      model['variables'][WRPlayer._Name+"_WR2"].position_rb1 = 0;
      model['variables'][WRPlayer._Name+"_WR2"].position_rb2 = 0;
      model['variables'][WRPlayer._Name+"_WR2"].position_wr1 = 0;
      model['variables'][WRPlayer._Name+"_WR2"].position_wr2 = 1;
      model['variables'][WRPlayer._Name+"_WR2"].position_wr3 = 0;
      model['variables'][WRPlayer._Name+"_WR2"].position_te = 0;
      model['variables'][WRPlayer._Name+"_WR2"].position_flex = 0;
      model['variables'][WRPlayer._Name+"_WR2"].position_dst = 0;
      model['variables'][WRPlayer._Name+"_WR2"].projection = WRPlayer._FPPG;
      model['variables'][WRPlayer._Name+"_WR2"].projection1 = WRPlayer._FPPG;

      model['variables'][WRPlayer._Name+"_WR2"][WRPlayer.playerID] = 1;
      model['variables'][WRPlayer._Name+"_WR2"]['VS_'+WRPlayer._Team] = 1;

      teams.forEach(function(singleTeam) {
        if(singleTeam === WRPlayer._Team) {
          model['variables'][WRPlayer._Name+"_WR2"][singleTeam] = 1;
        }
        else {
          model['variables'][WRPlayer._Name+"_WR2"][singleTeam] = 0;
        }
      });
    });
    _WR3PlayerPool.forEach(function(WRPlayer) {
      model['variables'][WRPlayer._Name+"_WR3"] = new Object();
      model['variables'][WRPlayer._Name+"_WR3"].salary = WRPlayer._Salary;
      model['variables'][WRPlayer._Name+"_WR3"].position_qb = 0;
      model['variables'][WRPlayer._Name+"_WR3"].position_rb1 = 0;
      model['variables'][WRPlayer._Name+"_WR3"].position_rb2 = 0;
      model['variables'][WRPlayer._Name+"_WR3"].position_wr1 = 0;
      model['variables'][WRPlayer._Name+"_WR3"].position_wr2 = 0;
      model['variables'][WRPlayer._Name+"_WR3"].position_wr3 = 1;
      model['variables'][WRPlayer._Name+"_WR3"].position_te = 0;
      model['variables'][WRPlayer._Name+"_WR3"].position_flex = 0;
      model['variables'][WRPlayer._Name+"_WR3"].position_dst = 0;
      model['variables'][WRPlayer._Name+"_WR3"].projection = WRPlayer._FPPG;
      model['variables'][WRPlayer._Name+"_WR3"].projection1 = WRPlayer._FPPG;

      model['variables'][WRPlayer._Name+"_WR3"][WRPlayer.playerID] = 1;
      model['variables'][WRPlayer._Name+"_WR3"]['VS_'+WRPlayer._Team] = 1;

      teams.forEach(function(singleTeam) {
        if(singleTeam === WRPlayer._Team) {
          model['variables'][WRPlayer._Name+"_WR3"][singleTeam] = 1;
        }
        else {
          model['variables'][WRPlayer._Name+"_WR3"][singleTeam] = 0;
        }
      });
    });
    _TEPlayerPool.forEach(function(TEPlayer) {
      model['variables'][TEPlayer._Name+"_TE"] = new Object();
      model['variables'][TEPlayer._Name+"_TE"].salary = TEPlayer._Salary;
      model['variables'][TEPlayer._Name+"_TE"].position_qb = 0;
      model['variables'][TEPlayer._Name+"_TE"].position_rb1 = 0;
      model['variables'][TEPlayer._Name+"_TE"].position_rb2 = 0;
      model['variables'][TEPlayer._Name+"_TE"].position_wr1 = 0;
      model['variables'][TEPlayer._Name+"_TE"].position_wr2 = 0;
      model['variables'][TEPlayer._Name+"_TE"].position_wr3 = 0;
      model['variables'][TEPlayer._Name+"_TE"].position_te = 1;
      model['variables'][TEPlayer._Name+"_TE"].position_flex = 0;
      model['variables'][TEPlayer._Name+"_TE"].position_dst = 0;
      model['variables'][TEPlayer._Name+"_TE"].projection = TEPlayer._FPPG;
      model['variables'][TEPlayer._Name+"_TE"].projection1 = TEPlayer._FPPG;
      model['variables'][TEPlayer._Name+"_TE"][TEPlayer.playerID] = 1;
      model['variables'][TEPlayer._Name+"_TE"]['VS_'+TEPlayer._Team] = 1;
      teams.forEach(function(singleTeam) {
        if(singleTeam === TEPlayer._Team) {
          model['variables'][TEPlayer._Name+"_TE"][singleTeam] = 1;
        }
        else {
          model['variables'][TEPlayer._Name+"_TE"][singleTeam] = 0;
        }
      });
    });
    _FLEXPlayerPool.forEach(function(FLEXPlayer) {
      model['variables'][FLEXPlayer._Name+"_FLEX"] = new Object();
      model['variables'][FLEXPlayer._Name+"_FLEX"].salary = FLEXPlayer._Salary;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_qb = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_rb1 = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_rb2 = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_wr1 = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_wr2 = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_wr3 = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_te = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_flex = 1;
      model['variables'][FLEXPlayer._Name+"_FLEX"].position_dst = 0;
      model['variables'][FLEXPlayer._Name+"_FLEX"].projection = FLEXPlayer._FPPG;
      model['variables'][FLEXPlayer._Name+"_FLEX"].projection1 = FLEXPlayer._FPPG;
      model['variables'][FLEXPlayer._Name+"_FLEX"][FLEXPlayer.playerID] = 1;
      model['variables'][FLEXPlayer._Name+"_FLEX"]['VS_'+FLEXPlayer._Team] = 1;

      teams.forEach(function(singleTeam) {
        if(singleTeam === FLEXPlayer._Team) {
          model['variables'][FLEXPlayer._Name+"_FLEX"][singleTeam] = 1;
        }
        else {
          model['variables'][FLEXPlayer._Name+"_FLEX"][singleTeam] = 0;
        }
      });
    });
    _DSTPlayerPool.forEach(function(DSTPlayer) {
      model['variables'][DSTPlayer._Name] = new Object();
      model['variables'][DSTPlayer._Name].salary = DSTPlayer._Salary;
      model['variables'][DSTPlayer._Name].position_qb = 0;
      model['variables'][DSTPlayer._Name].position_rb1 = 0;
      model['variables'][DSTPlayer._Name].position_rb2 = 0;
      model['variables'][DSTPlayer._Name].position_wr1 = 0;
      model['variables'][DSTPlayer._Name].position_wr2 = 0;
      model['variables'][DSTPlayer._Name].position_wr3 = 0;
      model['variables'][DSTPlayer._Name].position_te = 0;
      model['variables'][DSTPlayer._Name].position_flex = 0;
      model['variables'][DSTPlayer._Name].position_dst = 1;
      model['variables'][DSTPlayer._Name].projection = DSTPlayer._FPPG;
      model['variables'][DSTPlayer._Name].projection1 = DSTPlayer._FPPG;
      model['variables'][DSTPlayer._Name][DSTPlayer.playerID] = 1;
      // model['constraints']['VS_'+DSTPlayer._Opponent] = new Object();
      // model['constraints']['VS_'+DSTPlayer._Opponent]['max'] = Settings.Players_VS_Defense;
      //model['constraints']['VS_'+DSTPlayer._Opponent]['min'] = -0;

      teams.forEach(function(singleTeam) {
        if(singleTeam === DSTPlayer._Team) {
          model['variables'][DSTPlayer._Name][singleTeam] = 1;
        }
        else {
          model['variables'][DSTPlayer._Name][singleTeam] = 0;
        }
      });
    });
    model['ints'] = new Object();
    _QBPlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_QB"] = 1;
    });
    _RB1PlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_RB1"] = 1;
    });
    _RB2PlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_RB2"] = 1;
    });
    _WR1PlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_WR1"] = 1;
    });
    _WR2PlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_WR2"] = 1;
    });
    _WR3PlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_WR3"] = 1;
    });
    _TEPlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_TE"] = 1;
    });
    _FLEXPlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name+"_FLEX"] = 1;
    });
    _DSTPlayerPool.forEach(function(singlePlayer) {
      model['ints'][singlePlayer._Name] = 1;
    });
    ...
    var lastProjected = 0;
    while(lastProjected === 0) {

      if(lastProjected === 0) {
        model['constraints']['projection1'] = new Object();
        model['constraints']['projection1']['max'] = 10000;
        model['constraints']['projection1']['min'] = 0;
      }
      else {
        model['constraints']['projection1']['max'] = lastProjected - 0.01;
      }
              ...
              var tempDraft = {};
              _QBPlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_QB")) {
                  if(results[singlePlayer._Name+"_QB"] === 1) {
                    tempDraft['QB'] = singlePlayer;
                  }
                }
              });
              _RB1PlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_RB1")) {
                  if(results[singlePlayer._Name+"_RB1"] === 1) {
                    tempDraft['RB1'] = singlePlayer;
                  }
                }
              });
              _RB2PlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_RB2")) {
                  if(results[singlePlayer._Name+"_RB2"] === 1) {
                    tempDraft['RB2'] = singlePlayer;
                  }
                }
              });
              _WR1PlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_WR1")) {
                  if(results[singlePlayer._Name+"_WR1"] === 1) {
                    tempDraft['WR1'] = singlePlayer;
                  }
                }
              });
              _WR2PlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_WR2")) {
                  if(results[singlePlayer._Name+"_WR2"] === 1) {
                    tempDraft['WR2'] = singlePlayer;
                  }
                }
              });
              _WR3PlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_WR3")) {
                  if(results[singlePlayer._Name+"_WR3"] === 1) {
                    tempDraft['WR3'] = singlePlayer;
                  }
                }
              });
              _TEPlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_TE")) {
                  if(results[singlePlayer._Name+"_TE"] === 1) {
                    tempDraft['TE'] = singlePlayer;
                  }
                }
              });
              _FLEXPlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name+"_FLEX")) {
                  if(results[singlePlayer._Name+"_FLEX"] === 1) {
                    tempDraft['FLEX'] = singlePlayer;
                  }
                }
              });
              _DSTPlayerPool.forEach(function(singlePlayer) {
                if(results.hasOwnProperty(singlePlayer._Name)) {
                  if(results[singlePlayer._Name] === 1) {
                    tempDraft['DST'] = singlePlayer;
                  }
                }
              });
              ...
              finalPlayerList.push(tempDraft['FLEX']);
              finalPlayerList.push(tempDraft['DST']);

              //player name list
              var tempPlayerNames = [];
              tempPlayerNames.push(tempDraft['QB']._Name);
              tempPlayerNames.push(tempDraft['RB1']._Name);
              tempPlayerNames.push(tempDraft['RB2']._Name);
              tempPlayerNames.push(tempDraft['WR1']._Name);
              tempPlayerNames.push(tempDraft['WR2']._Name);
              tempPlayerNames.push(tempDraft['WR3']._Name);
              tempPlayerNames.push(tempDraft['TE']._Name);
              tempPlayerNames.push(tempDraft['FLEX']._Name);
              tempPlayerNames.push(tempDraft['DST']._Name);

              //add only valid drafts
              if(isDraftTeamValid(finalPlayerList) && isDraftSalaryValid(finalPlayerList) && !doesDraftHaveDupPlayers(finalPlayerList) && validSettings(finalPlayerList, Settings)) {
                 ...
                 if(tempPlayerNamesList.length > 0) {
                   ...
                   if(!sameDraft) {
                     ...
                     tempPlayerNamesList.push(tempPlayerNames);
                                   ...
                                   lastProjected = getDraftFPPG(finalPlayerList);
  ...
  function validSettings(draft, settings) {
    var valid_QB_RB_Stack = false;
    if (!settings.QB_RB_Stack)
    {
      valid_QB_RB_Stack = true;
    }
    var valid_QB_WR_Stack = false;
    if (!settings.QB_WR_Stack)
    {
      valid_QB_WR_Stack = true;
    }
    var valid_QB_TE_Stack = false;
    if (!settings.QB_TE_Stack)
    {
      valid_QB_TE_Stack = true;
    }
    var valid_Team_Stack_Players = false;
    var valid_Players_VS_Defense = false;

    var QB_Team = draft[0]._Team;
    var Defense_Team = draft[8]._Team;
    var teams = {};
    var num_players_vs_defense = 0;
    draft.forEach(function (player) {
        if (settings.QB_RB_Stack)
        {
            //check for QB & RB stack
            if(player._Position === 'RB' && !valid_QB_RB_Stack) {
              if(player._Team === QB_Team) {
                valid_QB_RB_Stack = true;
              }
            }
        }
        if(settings.QB_WR_Stack)
        {
          if(player._Position === 'WR' && !valid_QB_WR_Stack) {
            if(player._Team === QB_Team) {
              valid_QB_WR_Stack = true;
            }
          }
        ...
        if(settings.QB_TE_Stack)
        {
          if(player._Position === 'TE' && !valid_QB_TE_Stack) {
            if(player._Team === QB_Team) {
              valid_QB_WR_Stack = true;
            }
          }
        ...
        //check players vs defense
        if(Defense_Team === player._Opponent && player._Position !== 'DST') {
          num_players_vs_defense++;
        }
    ...
    if(num_players_vs_defense <= settings.Players_VS_Defense) {
      valid_Players_VS_Defense = true;
    }

    //check team data
    for (team in teams) {
        var value = teams[team];
        if(value >= settings.Team_Stack_Players) {
            valid_Team_Stack_Players = true;
        }
    }
    if (valid_QB_RB_Stack && valid_QB_WR_Stack && valid_QB_TE_Stack && valid_Team_Stack_Players && valid_Players_VS_Defense) {
      return true;
    }
    return false;
  }
...
},{"./node_modules/javascript-lp-solver/src/solver":31}],2:[function(require,module,exports){
/*global describe*/
/*global require*/
/*global module*/
/*global it*/
...
},{"../expressions.js":2,"./Tableau.js":8,"dup":15}],25:[function(require,module,exports){
...
},{"../expressions.js":2,"./MilpSolution.js":3,"./Model":4,"./Polyopt":5,"./Reformat":6,"./Solution.js":7,"./Tableau.js":8,"./Tableau/Tableau.js":11,"./Tableau/branchAndCut":13,"./Tableau/branchAndCut.js":13,"./Tableau/index.js":17,"./Validation":21,"./backup.js":22,"./branchingStrategies.js":23,"./cuttingStrategies.js":24,"./dynamicModification.js":25,"./expressions.js":26,"./integerProperties.js":27,"./log.js":28,"./main":29,"./simplex.js":30}]},{},[1]);
