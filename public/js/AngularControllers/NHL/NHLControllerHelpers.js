...
angular.module('NHLApp').controller('DKDraftModalController', function ($scope, $uibModalInstance, draft) {
...
angular.module('NHLApp').controller('SaveModalController', function ($scope, $uibModalInstance, $http, postObject, currentRead, site, $timeout) {
