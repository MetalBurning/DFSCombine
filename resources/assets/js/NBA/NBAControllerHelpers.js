...
angular.module('NBAApp').controller('DraftModalController', ['$scope', '$uibModalInstance', function ($scope, $uibModalInstance, draft) {
...
angular.module('NBAApp').controller('DKDraftModalController', ['$scope', '$uibModalInstance',  function ($scope, $uibModalInstance, draft) {
...
angular.module('NBAApp').controller('SaveModalController', ['$scope', '$uibModalInstance', '$http', '$timeout',  function ($scope, $uibModalInstance, $http, postObject, currentRead, site, $timeout) {
...
angular.module('NBAApp').controller('PlayerModalController', ['$scope', '$uibModalInstance',  function ($scope, $uibModalInstance, allPlayers, selectedPlayer) {
