                            ...
                            <div class="col-sm-8">
                                <div class="panel panel-default" >
                                    <div class="panel-heading">
                                        <div class='btn-toolbar pull-right'>
                                          ...
                                          <div class="btn-group">
                                            <button class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                              Select Slate <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu" >
                                              <li ng-repeat="singleSlate in _Slates" ng-click="selectSlate(singleSlate)"><a href="#">@{{singleSlate.Year}} - Week @{{singleSlate.Week}} - @{{singleSlate.Slate_Name}}</a></li>
                                            </ul>
                                          </div>
                                            <div class='btn-group'>
                                        ...
                                        <h3 class="panel-title">@{{_SelectedSlate}}</h3>
                                    </div>
