<table class="table table-hover" >
    <thead>
        <tr>
            ...
            <th>
                <span class="fake-link" ng-click="setDraftSortTypeAndReverse('FPPGDrop')">
                    FPPG Drop
                </span>
            </th>
            <th>
            ...
            <th>
                <span class="fake-link" ng-click="setDraftSortTypeAndReverse('ActualDrop')">
                    Actual Pts Drop
                </span>
            </th>
            <th>
    ...
    <tbody >
        <tr ng-repeat="draft in _AllDisplayedDraftData | orderBy:sortTypeDraft:sortReverseDraft">
            ...
            <td ng-click="openCloseDraftDetails(draft);">@{{draft.FPPGDrop}}</td>
            <td ng-click="openCloseDraftDetails(draft);">@{{draft.Actual}}</td>
            <td ng-click="openCloseDraftDetails(draft);">@{{draft.ActualDrop}}</td>
